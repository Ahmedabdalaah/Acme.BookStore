...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 124f72d7-d0ce-4656-8c83-47ff7e30b146
```

> `124f72d7-d0ce-4656-8c83-47ff7e30b146` is the password of the certificate, you can change it to any password you want.
